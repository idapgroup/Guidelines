...
{
    public class Number_converter_to_Ger : IConvert, IParseXml
    {
        ...
        public Number_converter_to_Ger(Parse_Xml obj)
        {
            Pars = obj;
        ...
        private string Second_discharge_Func(string str, int dischar, int dischar2)
        {
            ...
            {
                Form1.answer += ten_numbers[number % 10] + "und" + ordinal_ten[number / 10];
                str = "";
            }
            return str;
        }
        private string Third_discharge_Func(string str, int dischar, int dischar2)
        {
            ...
            {
                Form1.answer += ten_numbers[int.Parse(str.Substring(0, 1))] + discharge[dischar];
                str = str.Substring(1);
            }
            return str;
        }
