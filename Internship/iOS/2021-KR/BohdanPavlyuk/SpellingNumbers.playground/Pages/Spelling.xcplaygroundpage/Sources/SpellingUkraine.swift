...
public class SpellingNumbersInUkrainian {
    ...
    enum NumberEnd11_20:String ,CaseIterable{
        case zero = ""
        case first = " одинадцятий"
        case sekond = "дванадцятий"
        case third = "тринадцятий"
        case fourth = "чотирнадцятий"
        case fifth = "п'ятьнадцятий"
        case sixth = "шістьнадцятий"
        case seventh = "сімнадцятий"
        case eight = "вісімнадцятий"
        case ninth = "дев'ятнадцятий"
        case ten = "двадцятий"
    }
    ...
    func spellingNumbers1_100(number: Int) -> String {
        // Тернарний оператор
        switch number {
        ...
        case 11...20:
            ...
            let result = NumberEnd11_20.allCases[secondDigit].rawValue + theEding
    ...
    func spellingHundres(number: Int) -> String{
        if (number % 100) == 0 {
            ...
            let result = Hundreds.allCases[hundreds].rawValue + " " + spellingNumbers1_100(number: digits)
    ...
    func spellingBigNumber(thousands: Int, onlyThousands: Bool, end: String, end1: String) -> String {
        ...
        if number > 0 && number <= 10 {
            ...
            if (thousands % 1000) == 0 || onlyThousands {
                ...
                if end1 == thousends1 {
                    result = "\(NaturalNumbers.allCases[number].rawValue)"
                    ...
                    default:
                     ...
                     result = "\(NaturalNumbers.allCases[number].rawValue) \(end1)" + endType
        ...
        if number >= 11 && number <= 19 {
            ...
            if (thousands % 1000) == 0 || onlyThousands {
                let digit10 = number.digits[1]
                result = "\(BigNumberEnd11_20.allCases[digit10].rawValue + " " + end1)"
            } else {
                let digit1 = number.digits[1]
//                debugPrint(digit1)
                result = "\(BigNumber11_20.allCases[digit1].rawValue + " " + end)"
            }
        }
        ...
        if number >= 101 && number <= 110 && (thousands % 1000 ) != 0{
            ...
            result = "\(Hundreds.allCases[hundreds].rawValue) \(NaturalNumbers.allCases[digits].rawValue)"
        ...
        if number >= 120 && number < 1000 || number == 100 {
            ...
            result = "\(Hundreds.allCases[digit100].rawValue) \(Dozens.allCases [digit10].rawValue) \(NaturalNumbers.allCases[digit1].rawValue) \( end )"
            ...
            if (thousands % 1000) == 0 && (thousands % 10000) != 0 && (thousands % 100000) != 0 || onlyThousands {
                ...
                let digit1 = number.digits[2]
                let digit100 = number.digits[0]
                result = "\(Hundreds.allCases[digit100].rawValue) \(Tenth.allCases[digit10].rawValue)\(Millions1_9.allCases[digit1].rawValue + " " + end1)"
            }
...
//            let result = "\(quardrillionEnd)"
    ...
    func finalSpelling0_999(number: Int) -> String {
        var value: String = ""
        if number <= 99 {
            value = spellingNumbers1_100(number: number)
